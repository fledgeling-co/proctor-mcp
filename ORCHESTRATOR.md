...
**Inbox:** 6 untriaged briefs (151-156) from the full campaign run and the reckoning — a declared pass that never ran, 38 of 40 surfaces declaring no controls, 41 cases below the effect rung, 7 uncut journey boundaries, five warrant classes the figure-sourcing did not close, and two unjudged captures. `docs/reckoning/2026-08-25-FULL2/reckoning.md`.
