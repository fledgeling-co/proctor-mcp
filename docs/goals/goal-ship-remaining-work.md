...
| F-003 | PRO-0162 — Cut or Record Every Durable Boundary. | `journey_census.py --gate` | **measured 2026-08-27, work owed.** 44 boundaries claimed cut; **1** has a passing effect-rung case naming it. The census makes criterion 1 checkable and ratchets the 43 asserted-only cuts so no new one can be claimed without a case. Writing those cases is the remaining work. |
