...
| ID | Item | Gate | Status |
|---|---|---|---|
| F-001 | PRO-0160 — Control Census Across Every Surface. 38 of 40 surfaces declare no controls; 4 of 34 declared controls are actuated by a passing effect-rung case. | `finish-line` (ledger outstanding 0) | pending |
