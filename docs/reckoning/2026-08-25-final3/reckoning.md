...
4 piece(s) of work remain — 0 product, 4 evidence, 0 decision — across 963 ledger rows. This reckoning speaks for 469/472 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.

## What it can speak for

| Axis | Measured | Of | % | What the number means |
|---|---:|---:|---:|---|
| Cases adjudicated | 469 | 472 | 99.4% | an instrument returned a verdict on the product — pass or fail. A fail is knowledge; this is not a pass rate. |
| Cases ruled out by decision | 3 | 472 | 0.6% | somebody ruled the cell out of scope or not applicable. A decision, not a measurement, and it is kept out of the line above on purpose. |
...
|---|---:|---:|---|---|
| `unmeasured` | 4 | 4 | evidence-work | nobody found out — the work here is becoming able to tell |
| `waived` | 0 | 145 | exception | somebody decided not to — an exception, and it stays visible |
| `verified-done` | 0 | 814 | none | not remaining; kept so the denominator is honest |
