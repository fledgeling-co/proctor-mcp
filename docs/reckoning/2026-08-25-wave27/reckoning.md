...
137 piece(s) of work remain — 1 product, 23 evidence, 113 decision — across 960 ledger rows. This reckoning speaks for 466/469 (99%) of the campaign's designed cases and 124/141 (88%) of its stated requirements; the rest is not known to be done, it is simply not known.

## What it can speak for

| Axis | Measured | Of | % | What the number means |
|---|---:|---:|---:|---|
| Cases adjudicated | 466 | 469 | 99.4% | an instrument returned a verdict on the product — pass or fail. A fail is knowledge; this is not a pass rate. |
| Cases ruled out by decision | 3 | 469 | 0.6% | somebody ruled the cell out of scope or not applicable. A decision, not a measurement, and it is kept out of the line above on purpose. |
...
| `undecided` | 113 | 113 | decision-work | the documents and the evidence disagree; needs a person |
| `waived` | 0 | 28 | exception | somebody decided not to — an exception, and it stays visible |
| `verified-done` | 0 | 795 | none | not remaining; kept so the denominator is honest |
