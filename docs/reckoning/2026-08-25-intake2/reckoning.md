...
10 piece(s) of work remain — 2 product, 2 evidence, 6 decision — across 1007 ledger rows. This reckoning speaks for 497/500 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.
...
| Briefs joined to evidence | 156 | 156 | 100.0% | the brief could be tied to something in the registry at all. |
