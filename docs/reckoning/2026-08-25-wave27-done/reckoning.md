...
10 piece(s) of work remain — 1 product, 2 evidence, 7 decision — across 989 ledger rows. This reckoning speaks for 492/495 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.
...
| `waived` | 0 | 140 | exception | somebody decided not to — an exception, and it stays visible |
