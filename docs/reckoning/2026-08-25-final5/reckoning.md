...
4 piece(s) of work remain — 0 product, 2 evidence, 0 decision — across 965 ledger rows. This reckoning speaks for 470/473 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.

## What it can speak for

| Axis | Measured | Of | % | What the number means |
|---|---:|---:|---:|---|
| Cases adjudicated | 470 | 473 | 99.4% | an instrument returned a verdict on the product — pass or fail. A fail is knowledge; this is not a pass rate. |
| Cases ruled out by decision | 3 | 473 | 0.6% | somebody ruled the cell out of scope or not applicable. A decision, not a measurement, and it is kept out of the line above on purpose. |
...
| `retirable` | 2 | 2 | bookkeeping | already done to a standard that can carry the claim — close it |
| `waived` | 0 | 145 | exception | somebody decided not to — an exception, and it stays visible |
| `verified-done` | 0 | 816 | none | not remaining; kept so the denominator is honest |
...
- **BRIEF-111-retired-items-spec-closure** — Retired Items Standalone Spec Closure for PRO-0022, PRO-0031, PRO-0039
  - observed at rung 'effect-witness', at or above the 'outcome' floor, on a cited join — the work this brief asks for appears already done

## Decisions on the record (145)
