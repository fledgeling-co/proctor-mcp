...
16 piece(s) of work remain — 2 product, 2 evidence, 12 decision — across 1015 ledger rows. This reckoning speaks for 499/502 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.
...
| `verified-done` | 0 | 846 | none | not remaining; kept so the denominator is honest |
