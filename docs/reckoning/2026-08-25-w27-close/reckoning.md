...
9 piece(s) of work remain — 0 product, 2 evidence, 7 decision — across 979 ledger rows. This reckoning speaks for 483/486 (99%) of the campaign's designed cases and 139/141 (99%) of its stated requirements; the rest is not known to be done, it is simply not known.

## What it can speak for

| Axis | Measured | Of | % | What the number means |
|---|---:|---:|---:|---|
| Cases adjudicated | 483 | 486 | 99.4% | an instrument returned a verdict on the product — pass or fail. A fail is knowledge; this is not a pass rate. |
| Cases ruled out by decision | 3 | 486 | 0.6% | somebody ruled the cell out of scope or not applicable. A decision, not a measurement, and it is kept out of the line above on purpose. |
...
| `verified-done` | 0 | 830 | none | not remaining; kept so the denominator is honest |
